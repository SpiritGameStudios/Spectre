...
public record Cube(
	...
	public static final Codec<Cube> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		SpectreCodecs.VECTOR_3F_SIXTEENTH.optionalFieldOf("origin", new Vector3f(0F)).forGetter(Cube::origin),
		SpectreCodecs.VECTOR_3F_SIXTEENTH.optionalFieldOf("size", new Vector3f(1F)).forGetter(Cube::size),
		ExtraCodecs.VECTOR3F.optionalFieldOf("rotation", new Vector3f(0F)).forGetter(Cube::rotation),
		SpectreCodecs.VECTOR_3F_SIXTEENTH.optionalFieldOf("pivot", new Vector3f(0F)).forGetter(Cube::pivot),
