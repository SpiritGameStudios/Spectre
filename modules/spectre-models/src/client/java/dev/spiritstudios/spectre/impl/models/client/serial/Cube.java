...
public record Cube(
	...
	public static final Codec<Cube> CODEC = RecordCodecBuilder.create(instance -> instance.group(
		Codec.STRING.fieldOf("layer").forGetter(Cube::layer),
		ExtraCodecs.VECTOR3F.optionalFieldOf("from", new Vector3f(0F)).forGetter(Cube::from),
		ExtraCodecs.VECTOR3F.optionalFieldOf("to", new Vector3f(1F)).forGetter(Cube::to),
		Codec.either(
	...
	public void bake(CubeListBuilder builder) {
